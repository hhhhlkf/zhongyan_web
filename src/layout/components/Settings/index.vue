<template>
  <el-drawer v-model="showSettings" :withHeader="false" direction="rtl" size="300px">
    ...
    <div class="setting-drawer-title">
      <h3 class="drawer-title">顶部风格设置</h3>
    </div>
    <div class="setting-drawer-block-checbox">
      <el-radio-group v-model="radioBg" class="ml-4" @change="headerBgChange">
        <el-radio label="1" size="small">
          <img src="@/assets/img/bg1.png" alt="" style="width:100%;">
        </el-radio>
        <el-radio label="2" size="small">
          <img src="@/assets/img/bg2.png" alt="" style="width:100%;">
        </el-radio>
        <el-radio label="3" size="small">
...
const radioBg = ref(settingsStore.headerBg)
/** 是否需要topnav */
...
function saveSetting() {
  ...
  let layoutSetting = {
    ...
    "headerBg": storeSettings.value.headerBg,
  };
...
function headerBgChange(val) {
  settingsStore.changeSetting({ key: 'headerBg', value: val })
  // // 获取要修改背景图的元素
