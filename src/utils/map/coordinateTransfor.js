...
// 定义32649坐标系的proj4字符串
export const myCRS = {
    'EPSG:32649': new L.Proj.CRS('EPSG:32649', '+proj=utm +zone=49 +datum=WGS84 +units=m +no_defs',
        {
            resolutions: [8192, 4096, 2048, 1024, 512, 256, 128, 64, 32, 16, 8, 4, 2, 1, 0.5, 0.25, 0.125,],
            origin: [0, 0],
        }
    ),
    'EPSG:4326': new L.Proj.CRS('EPSG:4326', '+proj=longlat +datum=WGS84 +no_defs +type=crs',
        {
            resolutions: [8192, 4096, 2048, 1024, 512, 256, 128, 64, 32, 16, 8, 4, 2, 1, 0.5, 0.25, 0.125,],
            origin: [0, 0],
        }
